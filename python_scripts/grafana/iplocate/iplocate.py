...
with open('/var/www/apache/failedip/failedip.csv', 'a+') as csvfile:
        if os.stat('/var/www/apache/failedip/failedip.csv').st_size == 0:
            print("file is empty")
            ...
            with open('/var/www/apache/failedip/failedip.csv', 'r') as csvfile:
