...
;~ "TO GUI Control - It's a button, Digit #1", the parameters for this button's example are the following ones: 
...
; make the "input" field read only and right aligned, and make it readable
...
; actually show the GUI in a box
GUISetState() 
